...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white animate-fade-in">
      ...
      <EbookCard name={DataBook.name} description={DataBook.description} author={DataBook.author} src={DataBook.src} price={DataBook.price} smDescription={DataBook.smDescription} handleSubmit={handleSubmit} badge={DataPublic.badge}
