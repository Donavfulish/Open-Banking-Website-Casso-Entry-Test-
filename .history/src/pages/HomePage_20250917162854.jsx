...
// Mock Data (Nếu làm thành 1 hệ thống thì sẽ đưa về database + backend)
const DataBook = {
...
const DataPublic = {
  ...
  anbadge: "Powered by PayOS © 2024 Casso",
}
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white animate-fade-in">
      ...
      <EbookCard name={DataBook.name} description={DataBook.description} author={DataBook.author} src={DataBook.src} price={DataBook.price} smDescription={DataBook.smDescription} handleSubmit={handleSubmit} badge={DataPublic.badge} loading={loading} />
      <Footer anbadge={DataPublic.anbadge} />
    </div>
  )
}
