...
const crypto = require('crypto'); // Để tạo mã hash
const cors = require('cors'); // Để xử lý CORS từ frontend
const PayOS = require('pay')
const app = express();
...
app.post('/create-payment-link', async (req, res) => {
    try {
        ...
        const payosResponse = await axios.post(`${PAYOS_BASE_URL}/v2/payments`, {
            ...orderData,
